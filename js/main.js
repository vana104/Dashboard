...
function setValue(b1, b2, b3, b4, b5, b6) {

    var maxValue = 100;
    
    if (b1 > maxValue) maxValue = b1;
    if (b2 > maxValue) maxValue = b2;
    if (b3 > maxValue) maxValue = b3;
    if (b4 > maxValue) maxValue = b4;
    if (b5 > maxValue) maxValue = b5;
    if (b6 > maxValue) maxValue = b6;
    
    var perc1 = b1 * 100 / maxValue;
    var perc2 = b2 * 100 / maxValue;
    var perc3 = b3 * 100 / maxValue;
    var perc4 = b4 * 100 / maxValue;
    var perc5 = b5 * 100 / maxValue;
    var perc6 = b6 * 100 / maxValue;
...
$('.bar_val').keyup(function () {
    ...
    var val3 = ~~$('#bar3_val').val();
    var val4 = ~~$('#bar4_val').val();
    var val5 = ~~$('#bar5_val').val();
    var val6 = ~~$('#bar6_val').val();

    setValue(val1, val2, val3, val4, val5, val6)
});
